...
**Producto (v1.5.0-beta · tag `5e52bd6` · 2026-08-22):** Embudo + Lista AUTO · Finalistas · **DÍA D** · **CORE-R v1.12** · **CORE-P** · FA/FIE · DEMO / paper · **Operativa SEMI** (mesa Trading · Señales · Confirmar · Libro) · JWT / multi-user (ADR-027 C) · **Estudio ADR-024** · Asesor/Canales · **prep AUTO A0–A5** (`PAPER_D_EXECUTE` off). Sin broker live.  
