...
**Producto (V1.94 Financial Integrity · tip vivo `v1.93-beta` · 2026-09-03):** Embudo + Lista AUTO · Finalistas · **DÍA D** · **CORE-R** · **CORE-P** · FA/FIE · DEMO / paper · **Operativa SEMI** + **AUTO UI BETA-D** (armado `ACTIVAR AUTO` · execute opt-in `PAPER_D_EXECUTE`) · Decision Spine + Lifecycle Event Store / Outbox (V1.86–V1.93) · JWT / multi-user (ADR-027 C) · Estudio ADR-024 · Asesor/Señales. **No LIVE** · package `1.35.0-beta`. Thaw estricto en deuda. Estado canónico: [`docs/CURRENT_SYSTEM.md`](./docs/CURRENT_SYSTEM.md).
