...
Mapeo intent ↔ venue_order_id. ≠ PaperOrder status machine (OR-3).
...
SubmitIntentPhase = Literal["recorded", "venue_bound", "filled"]
...
class DurableSubmitIntent:
    """Intento persistido. recorded ≠ venue ack ≠ fill."""
