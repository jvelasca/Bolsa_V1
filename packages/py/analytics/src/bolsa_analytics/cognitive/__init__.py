...
# El eje de mercado de AUTO-3 se expone con nombre propio: ``MarketRegime`` en este
# paquete es el eje MACRO histórico de ``weight_rules`` (``risk_on``/``crisis``/...), así
# que el de AUTO-3 no puede reutilizar el nombre sin ambigüedad.
from bolsa_analytics.cognitive.operational_governor import (
    MarketRegime as GovernorMarketRegime,
)
...
__all__ = [
    ...
    "build_position_state_from_fill",
    "build_position_revision",
    # V2.40.1 — contexto de decisión con estado explícito (fail-closed).
    "TradeContext",
    "SectorResolutionStatus",
    "LiquidityStatus",
    "CorrelationStatus",
    ...
    "select_top_opportunities",
    "timeframe_seconds",
    # AUTO-3 / V2.43 — gobernador de riesgo y mercado (ejes, tabla y gate de entradas).
    "GOVERNOR_VERSION",
    "RISK_SCALE_BY_STATE",
    "DrawdownBand",
    "DrawdownPolicy",
    "GovernorMarketRegime",
    "GovernorPolicy",
    "LiquidityBand",
    "OperationalAssessment",
    "OperationalState",
