...
export const useUiStore = create<UiState>()(
  ...
  openChartGlobalBarSettings: () => set({ chartGlobalBarSettingsOpen: true }),
  closeChartGlobalBarSettings: () => set({ chartGlobalBarSettingsOpen: false }),
  ...
  openListHub: () => {
    void import('@/features/trading/open-list-hub').then(({ openListHubWorkspaceAction }) => {
  ...
  setChartDrawTool: (tool) =>
    set((state) => {
      ...
      writeDrawToolSessionLocal({ chartDrawTool: tool, lastDrawToolByGroup });
      return {
        chartDrawTool: tool,
        lastDrawToolByGroup,
        selectedDrawingId: null,
  ...
  setSelectedDrawingId: (id) =>
    set((state) => ({
      ...
      selectedIndicatorInstanceId: id ? null : state.selectedIndicatorInstanceId,
    })),
  ...
  setChartInspectorActiveShortcutKey: (key) => set({ chartInspectorActiveShortcutKey: key }),
