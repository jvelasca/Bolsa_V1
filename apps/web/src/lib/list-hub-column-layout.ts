...
export function resolveListHubColumnLayout(
  listConfig: ListPanelConfig,
): ListHubColumnLayoutItem[] {
  return normalizeListHubColumnLayout(listConfig.hubColumnLayout);
}

export function resolveListHubRowActionsWidth(
  listConfig: ListPanelConfig,
): number {
  return clampListHubRowActionsWidth(
    listConfig.hubRowActionsWidth ?? DEFAULT_LIST_HUB_ROW_ACTIONS_WIDTH,
  );
}

export function resolveListHubSort(
  listConfig: ListPanelConfig,
): ListHubSortState {
...
function flexibleHubColumnId(
  visibleColumns: ListHubColumnLayoutItem[],
): ListHubColumnId | null {
