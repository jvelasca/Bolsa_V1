    ...
    <>
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-base">
            {DATA_MARKET_SUMMARY.title}
          </CardTitle>
          <CardDescription>
            Ingesta de datos · sync {DATA_MARKET_SYNC.asOf}
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-2 text-sm">
          <p className="text-xs text-muted-foreground">
            {DATA_MARKET_SUMMARY.body}
          </p>
      ...
      <Card>
        <CardHeader className="pb-2">
          ...
          <CardDescription>
            Técnicos vs fundamentales — qué alimenta cada uno
          </CardDescription>
        </CardHeader>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          <CardHeader className="pb-2">
            ...
            <CardDescription>
              Estado en vivo del proveedor primario
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader className="pb-2">
            ...
            <CardDescription>
              Estado en vivo del complemento opcional
            </CardDescription>
          </CardHeader>
          <CardContent className="text-sm">
            {marketQuery.isLoading && (
      ...
      <Card>
        <CardHeader className="pb-2">
          ...
          <CardDescription>
            Listas · cola · gráfico · rastreadores
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-3 text-sm">
          <p className="text-xs text-muted-foreground">
            {DATA_UPDATE_SCOPE.plain}
          </p>
      ...
      <Card>
        <CardHeader className="pb-2">
          ...
          <CardDescription>
            Cómo se actualizan las velas y la ficha
          </CardDescription>
        </CardHeader>
        <CardContent>
          <ul className="space-y-3">
      ...
      <Card>
        <CardHeader className="pb-2">
          ...
          <CardDescription>
            Qué comprobamos antes y después de guardar
          </CardDescription>
        </CardHeader>
        <CardContent>
          <ul className="space-y-3">
      ...
      <Card>
        <CardHeader className="pb-2">
          ...
          <CardDescription>
            Modelos de consulta ·{" "}
            <code className="text-[10px]">{DATA_MARKET_SYNC.dataModel}</code>
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-base">
            {DATA_INSTRUMENT_LIFECYCLE.title}
          </CardTitle>
          <CardDescription>
            Listas ↔ PostgreSQL ·{" "}
            <code className="text-[10px]">{DATA_MARKET_SYNC.bdHint}</code>
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-2 text-sm">
          <p className="text-xs text-muted-foreground">
            {DATA_INSTRUMENT_LIFECYCLE.plain}
          </p>
          <ul className="list-disc space-y-1 pl-4 text-xs text-foreground">
      ...
      <Card>
        <CardHeader className="pb-2">
          ...
          <CardDescription>
            Detalle operativo · ADR-002 ·{" "}
            <code className="text-[10px]">{DATA_MARKET_SYNC.marketDoc}</code>
          </CardDescription>
        </CardHeader>
        <CardContent>
