...
export function BacktestingHelpSection({
  focusMonitor = false,
}: BacktestingHelpSectionProps) {
  useEffect(() => {
  ...
  return (
    <div className="space-y-4">
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-base">
            {BACKTESTING_SUMMARY.title}
          </CardTitle>
          <CardDescription>
            Backtesting · sync {BACKTESTING_SYNC.asOf} ·{" "}
            <Link
              to={BACKTESTING_SYNC.route}
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-base">
            {BACKTESTING_YOU_ARE_HERE.title}
          </CardTitle>
          <CardDescription>Ruta corta sin laboratorio</CardDescription>
        </CardHeader>
        <CardContent className="space-y-2 text-sm">
          <p className="text-xs text-muted-foreground">
            {BACKTESTING_YOU_ARE_HERE.body}
          </p>
          ...
          <p className="text-[11px] text-muted-foreground">
            {BACKTESTING_YOU_ARE_HERE.pause}
          </p>
        </CardContent>
      </Card>
        ...
        <CardHeader className="pb-2">
          ...
          <CardDescription>
            ...
            <code className="text-[10px]">
              {BACKTESTING_SYNC.operativaTestPlan}
            </code>
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-2 text-sm">
          <p className="text-xs text-muted-foreground">
            {BACKTESTING_DIA_D_GUIDE.body}
          </p>
          <ol className="list-decimal space-y-1 pl-4 text-xs text-foreground">
      ...
      <Card className="border-border/70">
        <CardHeader className="pb-2">
          <CardTitle className="text-base">
            {BACKTESTING_CORE_R_GUIDE.title}
          </CardTitle>
          <CardDescription>
      ...
      <Card>
        <CardHeader className="pb-2">
          ...
          <CardDescription>
            Qué hace cada pestaña — primero en claro, luego el detalle
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader className="pb-2">
          ...
          <CardDescription>
            Para no confundir simulación con dinero real
          </CardDescription>
        </CardHeader>
        <CardContent>
