...
export const AI_COGNITIVE_PHASES: AiTrackItem[] = [
  ...
  },
  {
    ...
    docRef:
      "packages/database/prisma/migrations/20260723010000_cognitive_persistence",
  },
  {
    id: "d7-obs",
...
export const AI_STACK_SUMMARY = [
  {
    layer: "LLM authoring",
    choice:
      "Ollama local (Qwen2.5-Coder) + OpenAI opcional + fallback heurístico",
  },
  {
    layer: "ML ranking",
    choice: "LightGBM (primario); CatBoost solo research",
  },
