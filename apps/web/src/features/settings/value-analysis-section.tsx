    ...
    <div className="space-y-4">
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-base">
            {VALUE_ANALYSIS_YOU_ARE_HERE.title}
          </CardTitle>
          <CardDescription>
            Orientación operativa · sync {VALUE_ANALYSIS_SYNC.asOf}
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-2 text-sm">
          <p className="text-xs text-muted-foreground">
            {VALUE_ANALYSIS_YOU_ARE_HERE.body}
          </p>
          ...
          <p className="text-[11px] text-muted-foreground">
            {VALUE_ANALYSIS_YOU_ARE_HERE.pause}
          </p>
      ...
      <Card>
        <CardHeader className="pb-2">
          ...
          <CardDescription>
            Entregado en código · listo para prueba en APP
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader className="pb-2">
          ...
          <CardDescription>
            Usar al validar refresh, UI, Screeners y Paper D
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader className="pb-2">
          ...
          <CardDescription>
            Lecturas multimodales y auditabilidad · sync{" "}
            {VALUE_ANALYSIS_SYNC.asOf}
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-3 text-sm">
          <div className="rounded-md border border-border bg-muted/20 px-3 py-2">
            <p className="text-xs font-medium text-foreground">
              {VALUE_ANALYSIS_PRINCIPLE.title}
            </p>
            <p className="mt-1 text-xs text-muted-foreground">
              {VALUE_ANALYSIS_PRINCIPLE.body}
            </p>
          </div>
      ...
      <Card>
        <CardHeader className="pb-2">
          ...
          <CardDescription>
            Caja negra: contexto → assessments → pesos → runtime →
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-base">
            WeightRules (orden de magnitud)
          </CardTitle>
          <CardDescription>
            Matriz base; el régimen (crisis/risk_off) la reajusta
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <p className="mt-2 text-[10px] text-muted-foreground">
            En Supervisado F3 verás el WeightContext real de cada propose
            (ruleVersion + faltantes).
          </p>
        </CardContent>
      </Card>
