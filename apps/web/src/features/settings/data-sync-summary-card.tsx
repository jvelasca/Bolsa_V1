  ...
  return (
    ...
    <Card>
      ...
      <CardHeader>
        ...
        <CardDescription>Captura Yahoo → BD local · sincronización automática</CardDescription>

      </CardHeader>

      <CardContent className="space-y-3 text-sm">

        {settingsQuery.isLoading && <p className="text-muted-foreground">Cargando…</p>}
        ...
        {settings && (
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <span className="text-muted-foreground">
              ...
              Escaneo cada {settings.scanIntervalMinutes} min · pausa {settings.minDelaySeconds}s
        ...
        <p className="text-muted-foreground">
          ...
          Configura proveedores, cola programada y roadmap gráfico en Configuración.
