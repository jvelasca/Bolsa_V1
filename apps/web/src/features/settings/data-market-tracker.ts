...
export const DATA_MARKET_SUMMARY = {
  ...
  body:
    'La app guarda en tu base de datos local el histórico de precios y una ficha fundamental de cada valor. Yahoo Finance es quien alimenta ese almacén. XTB (opcional) solo aporta la cotización del momento y sirve para comprobar que el cierre en BD no se ha desviado demasiado.',
  bullets: [
