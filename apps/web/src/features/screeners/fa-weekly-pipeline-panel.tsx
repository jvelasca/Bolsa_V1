    ...
    <div className={cn("space-y-3", className)}>
      <div className="flex flex-wrap items-end gap-2">
        ...
        <Button
          ...
          disabled={
            !listId || !gate || mutation.isPending || (wantExecute && !policyId)
          }
      ...
      <p className="text-[10px] text-muted-foreground">
        Manual: Screener FA + whitelist + Paper D. Cron:{" "}
        <code>FA_WEEKLY_CRON_ENABLED=1</code> +{" "}
        <code>FA_WEEKLY_UNIVERSE_LIST_ID</code>. Execute:{" "}
        <code>PAPER_D_EXECUTE=1</code>.
      </p>
