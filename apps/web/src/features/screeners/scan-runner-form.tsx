...
export function ScanRunnerForm({
  ...
  return (
    <div
      className={compact ? "space-y-3 text-sm" : "grid gap-4 md:grid-cols-2"}
    >
      ...
      <label className={compact ? "block" : "block md:col-span-1"}>
        ...
        <select
          ...
          onChange={(e) =>
            onChange({ timeframe: e.target.value as KernelTimeframe })
          }
          className={fieldClass}
        >
      ...
      <fieldset className={compact ? "space-y-2" : "space-y-2 md:col-span-2"}>
        ...
        <label className="flex items-center gap-2 text-sm">
          <input
            ...
            onChange={() =>
              onChange({ scanMode: "hybrid", scanSource: "preset" })
            }
          />
        ...
        >
          <label className="block">
            ...
            <select
              ...
              onChange={(e) =>
                onChange({
                  hybridGatePresetKey: e.target.value as BacktestStrategyType,
                })
              }
              className={fieldClass}
            >
          ...
          <label className="block">
            ...
            <input
              ...
              onChange={(e) =>
                onChange({ hybridMinScore: Number(e.target.value) })
              }
              className="mt-2 w-full"
            />
            <p className="mt-1 text-xs text-muted-foreground">
              Ordena por score técnico v1 (tendencia, momentum, volatilidad,
              reversión).
            </p>
          </label>
          <label className="block">
            ...
            <input
              ...
              onChange={(e) =>
                onChange({ hybridMinDataQuality: Number(e.target.value) })
              }
              className="mt-2 w-full"
            />
            <p className="mt-1 text-xs text-muted-foreground">
              0 = sin filtro. Filtra por frescura OHLCV, sync e integridad de
              barras.
            </p>
          </label>
          <label className="block">
            ...
            <input
              ...
              onChange={(e) =>
                onChange({
                  hybridMaxTrailingPe: e.target.value
          ...
          <label className="block">
            ...
            <input
              ...
              onChange={(e) =>
                onChange({
                  hybridMinMarketCapMillions: e.target.value
                    ? Number(e.target.value)
                    : null,
                })
              }
          ...
          <label className="block">
            ...
            <input
              ...
              onChange={(e) =>
                onChange({
                  hybridMinRoe: e.target.value ? Number(e.target.value) : null,
                })
              }
              className={fieldClass}
            />
          ...
          <label className="block">
            ...
            <input
              ...
              onChange={(e) =>
                onChange({
                  hybridMaxDebtToEquity: e.target.value
                    ? Number(e.target.value)
                    : null,
                })
              }
          ...
          <label className="block">
            ...
            <input
              ...
              onChange={(e) =>
                onChange({
                  hybridMinAltmanZ: e.target.value
                    ? Number(e.target.value)
                    : null,
                })
              }
          ...
          <label className="block">
            ...
            <input
              ...
              onChange={(e) =>
                onChange({
                  hybridMinFcfYield: e.target.value
                    ? Number(e.target.value)
                    : null,
                })
              }
          ...
          <label className="block">
            ...
            <input
              ...
              onChange={(e) =>
                onChange({
                  hybridMinCurrentRatio: e.target.value
                    ? Number(e.target.value)
                    : null,
                })
              }
          ...
          <label className="block">
            ...
            <input
              ...
              onChange={(e) =>
                onChange({
                  hybridMinPiotroski: e.target.value
                    ? Number(e.target.value)
                    : null,
                })
              }
            ...
            <p className="mt-1 text-[10px] text-muted-foreground">
              Solo filtra valores con F-Score completo en snapshot (si falta
              YoY, quedan fuera).
            </p>
          </label>
          <label className="block">
            ...
            <input
              ...
              onChange={(e) =>
                onChange({
                  hybridMinDcfUpside: e.target.value
                    ? Number(e.target.value)
                    : null,
                })
              }
          ...
          <label className="block">
            ...
            <input
              ...
              onChange={(e) =>
                onChange({
                  hybridMinGrahamUpside: e.target.value
                    ? Number(e.target.value)
                    : null,
                })
              }
          ...
          <label className="flex items-start gap-2 md:col-span-2">
            <input
              ...
              onChange={(e) =>
                onChange({ hybridUseSectorBands: e.target.checked })
              }
            />
            <span>
              Umbrales por sector (F2.2)
              <p className="mt-1 text-[10px] text-muted-foreground">
                Ajusta PE/ROE/D/E/Altman… según el sector Yahoo. En Financial
                Services se omiten Altman/D/E. Sin sector conocido usa los
                números de arriba (o defaults del catálogo).
              </p>
            </span>
          </label>
        </div>
            ...
            >
              {(
                ...
                return (
                  <optgroup
                    key={category}
                    label={STRATEGY_PRESET_CATEGORY_LABELS[category]}
                  >
                    {items.map((item) => (
                      <option
                        key={item.key}
      ...
      <label className={compact ? "block" : "block md:col-span-1"}>
        ...
        <input
          ...
          onChange={(e) =>
            onChange({ maxResults: Number(e.target.value) || 50 })
          }
          className={fieldClass}
        />
      </label>
...
export function scanConfigFromStrategyDefinition(
  ...
  if (strategy.kind === "hybrid" && strategy.definition.hybrid) {
    ...
    const fundamentalFields = scanFieldsFromFundamentalGate(
      hybrid.fundamentalGate,
    );
    return {
      ...config,
      scanMode: "hybrid",
      ...
      hybridMinDataQuality:
        hybrid.minDataQuality ?? DEFAULT_HYBRID_MIN_DATA_QUALITY,
      ...fundamentalFields,
    };
  }
  return {
