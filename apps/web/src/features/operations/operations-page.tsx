  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h2 className="text-2xl font-semibold tracking-tight">Mis operaciones</h2>
        ...
        <div className="flex flex-wrap gap-3 text-sm">
          <Link to="/trading" className="inline-flex items-center gap-1 text-primary hover:underline">
            Ir a Trading
            <ArrowRight className="h-4 w-4" />
          </Link>
          <Link to="/history" className="inline-flex items-center gap-1 text-muted-foreground hover:text-primary">
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          <Card>
            <CardHeader className="pb-1">
              ...
              <CardTitle className="text-2xl tabular-nums">{positionsCount}</CardTitle>
            </CardHeader>
          </Card>
          <Card>
            <CardHeader className="pb-1">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Misma vista que en Trading — posiciones en cartera y órdenes stop/limitadas.
          </CardDescription>
        </CardHeader>
