      ...
      <div className="w-full max-w-lg space-y-4 rounded-lg border border-border bg-card p-6 shadow-lg">
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              URL configurada:{" "}
              <code className="rounded bg-muted px-1">{getApiBaseUrl()}</code>
            </p>
          </div>
        </div>
        <div className="rounded-md bg-muted/50 p-3 text-xs text-muted-foreground">
          ...
          <ol className="mt-2 list-decimal space-y-1 pl-4">
            ...
            <li>
              Comprueba{" "}
              <code className="rounded bg-muted px-1">/api/health</code> en el
              puerto 8000
            </li>
            <li>
              Si usas F5 en Cursor, elige{" "}
              <strong>Bolsa: F5 Dev (recomendado)</strong>, no la config legacy
              TS (:3001)
            </li>
          </ol>
        </div>
