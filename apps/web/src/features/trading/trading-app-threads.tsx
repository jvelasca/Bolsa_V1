...
import { openHelpAiPlatform, useSupervisedF3QueueStore } from '@/stores/supervised-f3-queue-store';
      ...
      {listAutoActive && listAutoSummary ? (
        ...
        >
          ...
          <span
            ...
            aria-hidden
          />
          <span className="min-w-0 truncate tabular-nums">{listAutoSummary}</span>
        </Link>
      ) : (
        <span
