...
import { ArrowDown, ArrowUp, ArrowUpDown, GripVertical, MoreHorizontal, Star } from 'lucide-react';
          ...
          >
            ...
            >
              ...
              >
                ...
                <span className={cn('truncate', isCenteredListColumn(column.id) && 'text-[9px]')}>
            ...
            <div className="absolute right-0 top-full z-20 mt-1 min-w-[180px] rounded-md border border-border bg-card py-1 shadow-lg">
              ...
              {layout.map((column) => (
                ...
                >
                  ...
                  />
                  <span className="flex-1">{LIST_COLUMN_LABELS[column.id]}</span>
                  <button
                    type="button"
                    title={
                    ...
                    onClick={(event) => {
                      event.preventDefault();
                      updateListConfig(patchListFavoriteColumn(listConfig, listId, column.id));
                      save();
                    }}
                  >
                    <Star
