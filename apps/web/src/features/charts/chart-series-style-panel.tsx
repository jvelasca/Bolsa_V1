    ...
    <div className="space-y-4" id="inspector-config-series">
      <div>
        ...
        <p className="mt-1 text-[11px] text-muted-foreground">
          Afecta solo a este gráfico. Pulsa una opción para aplicarla; la
          estrella añade un acceso directo en la barra.
        </p>
      </div>
      ...
      {showParams && (
        <section className="space-y-2 border-t border-border pt-3">
          ...
          <p className="text-[11px] text-muted-foreground">
            Los valores vacíos usan un tamaño automático (~0,5 % del precio
            medio) o los defaults del tipo.
          </p>
          {seriesType === "renko" && (
            ...
            <>
              <FieldRow label="Tamaño de caja">
                <input
                  ...
                  onChange={(e) =>
                    onParamsChange({
                      pointAndFigureBox: e.target.value
                        ? Number(e.target.value)
                        : undefined,
                    })
                  }
              ...
              <FieldRow label="Reversión">
                <input
                  ...
                  onChange={(e) =>
                    onParamsChange({
                      pointAndFigureReversal: e.target.value
                        ? Number(e.target.value)
                        : undefined,
                    })
                  }
