...
describe('chart-strategy-bridge', () => {
  ...
  it('infers sma_crossover preset', () => {
    const specs = chartIndicatorInstancesToSpecs([
      { instanceId: '1', definitionId: 'sma', parameters: { period: 20 }, visible: true },
      { instanceId: '2', definitionId: 'sma', parameters: { period: 50 }, visible: true },
    ]);
  ...
  it('infers rsi_mean_reversion preset', () => {
    const specs = chartIndicatorInstancesToSpecs([
      { instanceId: '1', definitionId: 'rsi', parameters: { period: 14 }, visible: true },
    ]);
