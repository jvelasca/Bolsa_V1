...
export const HELP_SECTIONS: HelpSectionMeta[] = [
  ...
  },
  {
    ...
    sources: [
      ...
      { path: 'docs/DATA_MODEL.md', role: 'doc', note: 'investment_accounts types' },
  ...
  },
  {
    ...
    sources: [
      ...
      { path: 'docs/WORKSPACE_PERSISTENCE.md', role: 'doc', note: 'carouselListIds / persistencia' },
      { path: 'docs/MARKET_DATA.md', role: 'doc', note: 'Ciclo de vida listas↔BD' },
      {
  ...
  },
  {
    ...
    sources: [
      ...
      { path: AI_TRACKER_SYNC.solutionDoc, role: 'doc', note: 'Encabezado de estado' },
  ...
  },
  {
    ...
    sources: [
      ...
      { path: 'docs/MARKET_DATA.md', role: 'doc', note: 'Ingesta Yahoo/XTB · listas↔BD' },
      { path: 'docs/DATA_MODEL.md', role: 'doc', note: 'Tablas + ciclo de vida instrumento' },
      { path: 'docs/adr/002-yahoo-primary-xtb-secondary.md', role: 'adr' },
      { path: 'docs/adr/007-intraday-ohlcv-persistence.md', role: 'adr', note: 'Caché intradía' },
      {
