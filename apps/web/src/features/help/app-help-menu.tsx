    ...
    <div className="space-y-5 text-sm">
      ...
      <section>
        ...
        <ul className="space-y-2 text-muted-foreground">
          ...
          <li>
            <RouteLink to="/instruments">Instrumentos</RouteLink> — Hub del
            valor (tabla configurable: anchos, orden, favoritas; FA/TA;
      ...
      <section>
        ...
        <ul className="space-y-1 text-muted-foreground">
          <li>
            ...
            solo preferencias y ajustes: cuenta activa, espacio (General),
            comisiones, confirmaciones, sync, BD.
          </li>
          <li>
            <strong className="text-foreground">Ayuda (?)</strong> — guías y
            seguimiento. Las secciones de tracking (IA, datos, estado gráficos)
            salen de ficheros <code className="text-xs">*-tracker.ts</code>{" "}
            coordinados con docs (sync {HELP_CONTENT_AS_OF}).
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className="space-y-1 text-muted-foreground">
          ...
          <li>
            ...
            pendiente). Clic → gestor: cambiar, nuevo, duplicar, renombrar,{" "}
            <em>Exportar JSON</em> y <em>Guardar actual</em>. Autoguardado por
            defecto.
          </li>
          <li>
          ...
          <li>
            <strong>Configuración (⚙)</strong> — General (incluye restablecer
            paneles), perfil inversor, comisiones/fiscal, confirmaciones, BD,
            sync.
          </li>
          <li>
...
function AccountsContent() {
  return (
    <div className="space-y-4 text-sm text-muted-foreground">
      <p>
        Cada <strong>cuenta DEMO</strong> (simulada) es la unidad visible:
        efectivo, posiciones, comisiones y fiscal van unidos a ella. No hay
        subcarteras en la interfaz.
      </p>
      <section>
        ...
        <ul className="list-disc space-y-1 pl-5">
          <li>
            Solo se opera con{" "}
            <strong className="text-foreground">una cuenta activa</strong> a la
            vez (selector barra inferior / «Usar ahora»).
          </li>
          <li>
            Hoy todas las cuentas operativas son{" "}
            <strong className="text-foreground">DEMO</strong> (capital
            simulado).
          </li>
          <li>
            <strong className="text-foreground">Paper</strong> = futuro enlace a{" "}
            <em>broker real</em> por API — no es simulación y no se usa hasta
            entonces.
          </li>
        </ul>
      ...
      <section>
        ...
        <p className="text-muted-foreground">
          Es la cuenta con la que opera la app (Trading, patrimonio,
          Backtesting→demo, Radar, Supervisado). Se restaura al reabrir.
          Cámbiala en el selector de la barra o en{" "}
          <RouteLink to="/accounts">Cuentas</RouteLink> con «Usar ahora». Puedes
          tener varias demos (p. ej. otro mercado); solo una es la activa.
        </p>
      </section>
      <section>
        <h3 className="mb-2 font-semibold text-foreground">
        ...
        <ul className="list-disc space-y-1 pl-5">
          ...
          <li>
            <strong>Comisión y cargos</strong> — se descuentan del efectivo:
            comisión broker (% con mín/máx), IVA, impuesto de transmisiones en
            compras y, si aplica, custodia anual sobre patrimonio.
          </li>
          <li>
            <strong>Compra / Venta</strong> — importe de la operación; las
            comisiones van en líneas separadas.
          </li>
        </ul>
      </section>
      <section>
        ...
        <p>
          Desde <RouteLink to="/accounts">Cuentas</RouteLink> →{" "}
          <em>Nueva demo</em>. El asistente pide identidad, capital,{" "}
          <strong>perfil inversor del catálogo</strong> (lista selectable; o
          crear uno nuevo), comisiones y fiscal. Una cuenta = un perfil activo.
          Se cambia después en{" "}
          <OpenConfigLink tab="investor-profile">
            Configuración → Perfil inversor
          </OpenConfigLink>{" "}
          o en la ficha de la cuenta.
        </p>
      </section>
      <section>
        <h3 className="mb-2 font-semibold text-foreground">
      ...
      <section>
        <h3 className="mb-2 font-semibold text-foreground">
          Ciclo de vida (modo demo)
        </h3>
        <ol className="list-decimal space-y-1 pl-5">
          <li>
            <strong>Editar</strong> — Nombre y descripción en Configuración de
            la cuenta.
          </li>
          <li>
    ...
    <div className="space-y-4 text-sm text-muted-foreground">
      ...
      <section>
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5">
          <li>
            <strong className="text-foreground">Recomendación</strong> — Índice
            Operativo (IO), gauges TA/FA, ranking «El n de N en Estudio», TOP #1
            / adopción, enlaces{" "}
            <strong className="text-foreground">Abrir estudio (LAB)</strong> y{" "}
            <strong className="text-foreground">Verificar D→hoy</strong> (si hay
            DÍA D en el pasado).
          </li>
          <li>
            <strong className="text-foreground">Info</strong> — mandato /
            Learning / Outcomes.
          </li>
        </ul>
        <p className="mt-2">
          <strong className="text-foreground">Manual / SEMI / AUTO</strong> es
        ...
        <p className="mt-2">
          Lista virtual{" "}
          <strong className="text-foreground">Visualizados</strong> = pestañas
          de gráfico abiertas (scratch; no supervisión). Selección:{" "}
          <strong className="text-foreground">A Estudio</strong> ·{" "}
          <strong className="text-foreground">Quitar</strong> (cierra pestañas)
          · <strong className="text-foreground">Por IO</strong> (mejor Índice
          Operativo a la izquierda). Columnas (⋯): IO · TA · FA · ★ Dict. ·
          Postura. Al buscar o cambiar de pestaña: prioriza lista{" "}
          <strong className="text-foreground">Cartera → Estudio → resto</strong>{" "}
          y hace scroll del valor al tope. Lista API{" "}
          <strong className="text-foreground">Estudio</strong> = universo
          supervisable (membresía explícita). Abrir/cerrar gráfico <em>no</em>{" "}
          cambia Estudio. En Estudio: Actualizar / Redescubrir · Supervisión ON
        ...
        <p>
          ...
          <strong className="text-foreground">OPERATIVA: …</strong> · métricas.
          Derecha (ancho fijo):{" "}
          <strong className="text-foreground">Colas</strong> (Velas · CORE-R ·
          F3 · Lista AUTO) y{" "}
          <strong className="text-foreground">Alarmas Radar</strong> (badge nº
          sin leer). El rail no salta al cambiar conteos.
        </p>
      </section>
      <section>
        <h3 className="mb-2 font-semibold text-foreground">
          Mandato operativo (ADR-020)
        </h3>
        <p>
          Cuando <strong className="text-foreground">Adoptas</strong> un
          Finalista (Checklist / Camino A), se abre un{" "}
          <strong className="text-foreground">mandato vigente</strong> para ese
          instrumento×cuenta: qué estrategia gobierna la operativa y desde
          cuándo. Si adoptas otra, el tramo anterior se cierra y queda en el
          historial (actor usuario / Operativa / CORE-R).
        </p>
        <ul className="mt-2 list-disc space-y-1 pl-5">
          <li>
            Timeline en Operativa → Info: tramos, motivo del cambio y resumen de
            churn (usuario vs sistema).
          </li>
          <li>
            Los trades DEMO (orden mercado / pendientes) se{" "}
            <strong className="text-foreground">enlazan</strong> al mandato
            vigente (local) para atribución futura.
          </li>
          <li>
            Distinto de Finalistas LAB (estudio) y del tag “setup” de un trade
            suelto.
          </li>
        </ul>
        <p className="mt-2">
      ...
      <section>
        <h3 className="mb-2 font-semibold text-foreground">
          Alarmas Radar (barra inferior)
        </h3>
        <p>
          La campana junto a los hilos muestra el{" "}
          <strong className="text-foreground">inbox de entrada/salida</strong>{" "}
          de rastreadores. Llegan desde un scan manual en Screeners o desde un
          job programado (<code className="text-[0.85em]">on_bar_close</code>),
          aunque Screeners no esté abierto. Solo alarmas de la{" "}
          <strong className="text-foreground">cuenta activa DEMO</strong>. Clic
          en un valor → abre el gráfico;{" "}
          <strong className="text-foreground">F3</strong> → propone y abre
          Confirm supervisado. No ejecuta órdenes sola.
        </p>
      </section>
      <section>
        <h3 className="mb-2 font-semibold text-foreground">
        ...
        <ul className="list-disc space-y-1 pl-5">
          ...
          <li>
            <strong>Barra global del gráfico</strong> (arriba): indicadores,
            compra/venta rápida, estado de datos, inspector. Su ⚙ configura solo
            esa barra.
          </li>
          <li>
            <strong>Barra de datos</strong> (Escala · Valor · Cursor):
            timeframe, metadatos del valor, OHLC bajo el cursor. La{" "}
            <strong>estrella</strong> en cada zona añade accesos directos; el ⚙
            de esa barra configura visibilidad, fondo y favoritos.
          </li>
          <li>
            <strong>Inspector</strong> (panel derecho): modo{" "}
            <strong>Datos</strong> (instrumento, gráfico, vela, BD) y modo{" "}
            <strong>Config</strong> (capas, objetos, estilos, selección).
          </li>
          <li>
            Indicadores técnicos desde el catálogo; dibujos y plantillas en el
            inspector.
          </li>
          <li>
            <strong className="text-foreground">Finalista #1</strong>: switch
            «todos» en la barra general (Indicadores) y «este» en la barra del
            gráfico en uso. OFF quita solo overlays con origen finalist-top1.
          </li>
          <li>
            <strong>Gate bar-a-bar</strong> (estrategias híbridas): superponer
            la línea de paso de gate desde una estrategia guardada.
          </li>
        </ul>
      </section>
      <section>
        ...
        <ul className="list-disc space-y-1 pl-5">
          <li>
            Catálogo de indicadores → asistente por prompt: describe el
            indicador en lenguaje natural.
          </li>
          <li>
            Borrador vía <code>AIGovernanceProxy</code> (Ollama / OpenAI /
            heurística). Revisa antes de añadir al gráfico.
          </li>
          <li>
      ...
      <section>
        <h3 className="mb-2 font-semibold text-foreground">
          Decision Engine (supervisado)
        </h3>
        <ul className="list-disc space-y-1 pl-5 text-muted-foreground">
          <li>
            Los motores emiten{" "}
            <strong className="text-foreground">Assessments</strong> (informe),
            no órdenes. El{" "}
            <strong className="text-foreground">DecisionRuntime</strong> propone
            la acción; el Policy Gate solo verifica (pasivo en propose, hard en
            paper_auto).
          </li>
          <li>
            El LLM <strong className="text-foreground">nunca</strong> envía
            órdenes ni calcula PnL. Backtest y trading automático{" "}
            <strong className="text-foreground">sí</strong> operan y miden PnL —
            vía motor determinista + Gate, no vía chat. Macro live (Yahoo ^VIX)
      ...
      <section>
        ...
        <ul className="list-disc space-y-1 pl-5">
          ...
          <li>
            ...
            <OpenConfigLink tab="confirmations">
              Configuración → Confirmaciones
            </OpenConfigLink>
            .
          </li>
        </ul>
      ...
      <section>
        ...
        <ul className="list-disc space-y-1 pl-5">
          <li>
            Al arrancar:{" "}
            <strong className="text-foreground">último espacio activo</strong>{" "}
            de este dispositivo; si no hay, el marcado como preferido
            (estrella).
          </li>
          <li>
            Chip superior (nombre) → gestor: cambiar, <em>Nuevo (blanco)</em>,{" "}
            <em>Duplicar activo</em>, renombrar, eliminar,{" "}
            <em>Exportar JSON</em>, <em>Guardar actual</em>.
          </li>
          <li>
            Autoguardado y plantilla de gráficos nuevos:{" "}
            <OpenConfigLink tab="general">
              Configuración → General
            </OpenConfigLink>{" "}
            o el propio gestor.
          </li>
          <li>
            Se persisten gráficos abiertos, dibujos, listas y preferencias en el
            servidor. El layout de paneles Trading y los anchos de columnas de
            listas se guardan en este dispositivo (no se pisan al cambiar de
            PC).
          </li>
          <li>
      ...
      <section>
        ...
        <p className="mb-1">
          Consola del navegador (F12), con el gráfico abierto:
        </p>
        <ol className="list-decimal space-y-1 pl-5">
          <li>
            <code>bolsaPerfStart()</code> → usa la app →{" "}
            <code>bolsaPerfStop()</code>
          </li>
          <li>
        ...
        <p className="mt-2 text-xs">
          Detalle en <code>docs/PERFORMANCE.md</code>.
        </p>
      </section>
    </div>
  );
...
function FiscalContent() {
  return (
    <div className="space-y-4 text-sm text-muted-foreground">
      <p>
        Cada cuenta tiene perfil fiscal configurable (jurisdicción ES por
        defecto): método de coste (FIFO o coste medio), transmisiones, retención
        dividendos y tipo sobre plusvalías. Edición en{" "}
        <OpenConfigLink tab="commissions">
          Configuración → Comisiones y fiscal
        </OpenConfigLink>
        .
      </p>
      <section>
      ...
      <section>
        ...
        <p>
          En <RouteLink to="/fiscal">Fiscal</RouteLink>: plusvalías realizadas,
          latentes, comisiones acumuladas y estimación de impuesto.
        </p>
      </section>
    </div>
  );
...
function AboutContent() {
  return (
    <div className="space-y-4 text-sm">
      <p className="text-muted-foreground">
        <strong className="text-foreground">Bolsa V1</strong> — plataforma
        personal de gestión bursátil inspirada en terminales profesionales
        (ProRealTime / XTB). Backend FastAPI + PostgreSQL; frontend React +
        Vite.
      </p>
      ...
      <p className="text-xs text-muted-foreground">
        Docs: <code>docs/HELP.md</code> (mapa Ayuda),{" "}
        <code>docs/AI_PLATFORM_SOLUTION.md</code>,{" "}
        <code>docs/API_REFERENCE.md</code>. Contenido de seguimiento sync{" "}
        {HELP_CONTENT_AS_OF}.
      </p>
      ...
      content = (
        <div className="space-y-3">
          <p className="text-sm text-muted-foreground">
            ...
            <strong className="text-foreground">ajustes</strong> de cola
            automática están en{" "}
