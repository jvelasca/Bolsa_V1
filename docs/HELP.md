...
> **Sync:** `HELP_CONTENT_AS_OF` = **2026-09-07** (tip producto **v2.11-beta** · package `1.40.0-beta` · Confirm LIVE VIRTUAL (simulado) · camino usuario **«Del activo a la operación»** · UI ≠ settlement · `PAPER_D_EXECUTE` off · Accept estricto abierto · W+5 **0/5**)  
