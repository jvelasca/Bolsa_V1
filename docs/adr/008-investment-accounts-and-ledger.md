...
**Aceptado** — jul 2026  
**Implementado (jul 2026):** Fase 0–2 con modelo XTB (cuenta = unidad UI; cartera interna única). Hub `/accounts`, ledger, fiscal, comisiones, custodia. Ver [PROJECT_STATE.md](../PROJECT_STATE.md).
