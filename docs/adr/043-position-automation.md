...
Cinco verdades: product · git tag · package · schema · API. [`versioning.md`](../engineering/versioning.md). Product `V1.45-beta`. Package `1.35.0-beta` congelado. Tip certificado `v1.45-beta` → `6ca5ec12`.
