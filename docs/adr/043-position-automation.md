...
- PASS V1.44 = contrato; PASS V1.45 = execute PAPER opt-in; V1.46 = foundation; V1.47 = Runtime Truth; V1.48 = Event Continuity; V1.49 = Entry AUTO; V1.50 = integridad de decisión (auditoría PASS). V1.51 = Entry fill → Position birth (auditoría PASS 9,1). V1.52 = Position Lifecycle rebanada. V1.53 = Golden Session pytest. V1.54 = Operating Desk UI rebanada ([`spec-v154-operating-desk-2026-09-01.md`](../engineering/spec-v154-operating-desk-2026-09-01.md)). **No** LIVE · **no** DeskRunner multi-día · **no** redesign inbox.

## 7. Fuera

auto-promote · Lab P2 · OCO · broker trailing · thaw LIVE · Alembic tabla nueva · bump package · nav L1 · `PAPER_D_EXECUTE` default on · browser E2E Daily Journal · retrofit Lab execute como SoT (V1.52: Lab execute DENY). Redesign Daily Desk · scheduler · rankingEngineId (**post-V1.54**).
