...
Cinco verdades: product · git tag · package · schema · API. [`versioning.md`](../engineering/versioning.md). Product `V1.50-beta`. Package `1.35.0-beta` congelado. Tip `v1.50-beta` → `9e511715` (CI pendiente; previo `v1.49-beta` → `c8975c9d`).
