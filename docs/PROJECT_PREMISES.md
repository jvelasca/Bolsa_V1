...
> **AsOf:** 2026-08-22 · **Fuente de coordinación:** GitHub [`jvelasca/Bolsa_V1`](https://github.com/jvelasca/Bolsa_V1) rama **`main`**. SHA vivo = `git fetch && git rev-parse origin/main` → **`a93ac9f`**. Tag **`v1.5.0-beta` → `5e52bd6`** · tag **`v1.3.0` → `b778292`** intacto · **BETA / NO en producción**.
...
- **Track B APROBADO** (2026-08-21, línea a línea). Track C: plan [`engineering/plan-r12-track-c-frontend-2026-08-21.md`](./engineering/plan-r12-track-c-frontend-2026-08-21.md). **C1–C5** (`0eb8976`) + leftover CORE-R **`8dd3caf`** + copy E8 **`ce601c9`**. Gates: **R12-409** `eb24608` · **EXEC-B-CONC** `ca60d0a` · **R12-SCHED** `5e52bd6` · **R12-ACCOUNTS** `3c958f1` · **R12-AUTH F1–F10 + F8b–F8e** · **F7b script** · **JWT-only gate** · ADR-027 **Aceptado**.
- **Gates no auto-abiertos:** purge `pending-delete` ventana métricas **abierta 2026-08-22** + kit log local (E8 sigue N) — plan [`plan-r12-pending-delete-v2-purge-2026-08-22.md`](./engineering/plan-r12-pending-delete-v2-purge-2026-08-22.md). D4 auth **cerrado** (F7b script / JWT-only en este árbol) — F7c / apply prod no auto.
