...
> **AsOf:** 2026-08-25 · **ADR-031** tesis ≠ plan ≠ permiso · **ADR-032** Operational Core v1.9 (docs-only, no implementado) · **ADR-023 Accepted BETA-D** · **A3-wire** `d704263` · **C1–C5** consolidación v1.8.1 · **C6 stamp** (tag `v1.8.1-beta` parked). Alembic `010` en `bolsa_v1`.
...
> **Auditoría:** pack v1.8.0 [`audit-pack-estado-global-2026-08-25-v180.md`](./engineering/audit-pack-estado-global-2026-08-25-v180.md) · consolidación v1.8.1 [`audit-pack-estado-global-2026-08-25-v181.md`](./engineering/audit-pack-estado-global-2026-08-25-v181.md) (tag `v1.8.1-beta` **parked**). Relevo tag 1.8.0 [`traspaso-relevo-tag-v1-8-0-beta-2026-08-25.md`](./engineering/traspaso-relevo-tag-v1-8-0-beta-2026-08-25.md).
...
- **ADR-032 docs-only (v1.9, no implementado):** contrato Operational Core — `TradePlan` (si entramos) · `PositionState` (tras entrar) · `ExitPlan` / `ExecutionPlan` (envío futuro). Thin 5.x/8.x = stand-in advisory, no arquitectura final. **No** mappers thin nuevos. NO TRADE es métrica de calidad. [`032-operational-core-tradeplan-positionstate-execution.md`](./adr/032-operational-core-tradeplan-positionstate-execution.md).
...
- **Ciclo C6 stamp v1.8.1:** pack [`audit-pack-estado-global-2026-08-25-v181.md`](./engineering/audit-pack-estado-global-2026-08-25-v181.md). Spine **161** · shared **84** · Prisma fail-closed. Tag `v1.8.1-beta` **parked**. Siguiente: v1.9 ADR-032 **o** operar SEMI.
...
| Comando                    | Qué cubre                                                                                                                                                                                                                                                                                                                                               |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `pnpm test:decision-spine` | Cadena decisión: confirm SEMI (TTL/precio/H3), Fit, risk, pending fill, TradePlan A/B/C/H/G + 4.0–4.8 + Board echo 4.9 + Journal Attribution 6 + Thesis Health 5.0 + Protect/T1 5.1 + Exit Radar 5.2 + MFE/MAE 5.3 + Expectancy 8.0 + Trail 8.1 + Bracket 8.2 + I1 opening helper / HTTP gated trade, AUTO veto, Golden, **DS-05**, **DS-03** (**161**) |
