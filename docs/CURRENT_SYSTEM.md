...
> **AsOf:** 2026-08-25 · **ADR-031** tesis ≠ plan ≠ permiso · **ADR-032** Operational Core v1.9 (docs-only, no implementado) · **ADR-023 Accepted BETA-D** · **A3-wire** `d704263` · **C1 Hoy honesty** (v1.8.1 P0) · **C2 Alembic-only** · **C3 ActionQueue** · **C5 MFE/Expectancy honesty**. Alembic `010` en `bolsa_v1`.
