...
> **AsOf:** 2026-08-25 · **ADR-031** tesis ≠ plan ≠ permiso. HEAD **`a10c356`** = `origin/main` (Ciclo 4.8 `b381d06`). Relevo vivo: [`traspaso-relevo-ciclo-48-wyckoff-surface-effort-cierre-2026-08-25.md`](./engineering/traspaso-relevo-ciclo-48-wyckoff-surface-effort-cierre-2026-08-25.md). Alembic `010` en `bolsa_v1`.
