...
> **AsOf:** 2026-08-24 · ciclo beta slice **CERRADO**. HEAD **`386a959`** = `origin/main`. Ciclo 1 F1–F3 CERRADO. F9-A CERRADO. **Python CI VERDE** (Ruff · Import-linter · Mypy · Pytest). Alembic `010` en `bolsa_v1`.
