...
> **AsOf:** 2026-08-25 · **ADR-031** tesis ≠ plan ≠ permiso. HEAD local **`655832c`** (feat 8.1; stamp pending; 8.0 `cf880eb`; RX1 `9289b53`; origin aún `05e354c`). Relevo vivo: [`traspaso-relevo-ciclo-8-1-trail-thin-2026-08-25.md`](./engineering/traspaso-relevo-ciclo-8-1-trail-thin-2026-08-25.md) (Trail thin advisory; **hint only** · park 8.2 / trail plena). Alembic `010` en `bolsa_v1`.
...
- Diferido ADR-031: Alembic/tabla Wyckoff / `wyckoffPhase` contrato (parked), trailing **plena** broker / mutar stop (tras 8.1 thin), bracket / T1 parcial (**8.2**), thesis health **plena** (persistencia Confidence lifecycle), expectancy **plena**, Shadow AUTO **thaw** (ADR-023 Proposed), broker. **Línea integridad I1–I3 CERRADA** + residual **RX1** exits honesty (`9289b53`). **Ciclo 8.0 + 8.1 CERRADOS.** **No** I4 thaw por defecto. **No** auto-exit producto. **No** reabrir Wyckoff thin por defecto.

## Tests

| Comando                    | Qué cubre                                                                                                                                                                                                                                                                                                                                 |
| -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `pnpm test:decision-spine` | Cadena decisión: confirm SEMI (TTL/precio/H3), Fit, risk, pending fill, TradePlan A/B/C/H/G + 4.0–4.8 + Board echo 4.9 + Journal Attribution 6 + Thesis Health 5.0 + Protect/T1 5.1 + Exit Radar 5.2 + MFE/MAE 5.3 + Expectancy 8.0 + Trail 8.1 + I1 opening helper / HTTP gated trade, AUTO veto, Golden, **DS-05**, **DS-03** (**155**) |
