...
> **AsOf:** 2026-08-25 · **ADR-031** tesis ≠ plan ≠ permiso · **ADR-032** Operational Core v1.9 · **F1–F4** · **ExitPermission** · **INFRA CI-by-tag** · **ADR-023 Accepted BETA-D** · **A3-wire** `d704263` · **C1–C6** consolidación v1.8.1 **CERRADA**. Alembic `010` en `bolsa_v1`.
> **Tag:** **`v1.9-beta`** (SHA se pinea tras publish). Previo: **`v1.8.1-beta` → `e78fbb9`**. **BETA / no producción.** Roadmap: [`roadmap-v19-operational-core-2026-08-25.md`](./engineering/roadmap-v19-operational-core-2026-08-25.md). Pack: [`audit-pack-estado-global-2026-08-25-v19.md`](./engineering/audit-pack-estado-global-2026-08-25-v19.md).
> **Auditoría:** pack v1.9 [`audit-pack-estado-global-2026-08-25-v19.md`](./engineering/audit-pack-estado-global-2026-08-25-v19.md) · relevo tag [`traspaso-relevo-tag-v1-9-beta-2026-08-25.md`](./engineering/traspaso-relevo-tag-v1-9-beta-2026-08-25.md) · triage v1.8.1 [`audit-ext-v181-triage-2026-08-25.md`](./engineering/audit-ext-v181-triage-2026-08-25.md).
...
- **ADR-032 Operational Core v1.9:** **F1–F4 + ExitPermission CERRADOS** · broker adapter **no**. Thin 5.x/8.x = stand-in. **No** mappers thin nuevos. **No** ActionabilityScore. **No** `contract:gen`. [`032-operational-core-tradeplan-positionstate-execution.md`](./adr/032-operational-core-tradeplan-positionstate-execution.md).
...
- **F2+F2.1 PositionState:** `positionId` · `tradePlanId` · status `OPEN`/`PARTIAL`/`PROTECTED`/`CLOSED` · planned/actual entry · initial/current stop · T1/T2 · qty/remaining · mark→`unrealizedR` · reduce→`realizedR` · MFE/MAE proxy en mark · stubs thesis/protect/trail. **No** wire Confirm. Thin **no** promocionados.
- **F3 ExitPlan:** `exitPlanId` · `positionId` · `tradePlanId` · status `IDLE`/`HINT`/`ARMED`/`TRIGGERED`/`DONE` · razones canónicas gap §3 · `suggestedAction` advisory. **No** muta PositionState · **No** auto-exit · thin exitRadar **≠** ExitPlan.
...
- **ExitPermission:** `checkExitPermission` / `check_exit_permission` ALLOW/DENY · reasons canónicas · **≠** `check_opening` · **≠** auto-exit · sin wire Confirm. Plan [`plan-exit-permission-2026-08-25.md`](./engineering/plan-exit-permission-2026-08-25.md).
...
| Comando                    | Qué cubre                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| -------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `pnpm test:decision-spine` | Cadena decisión: confirm SEMI (TTL/precio/H3), Fit, risk, pending fill, TradePlan A/B/C/H/G + 4.0–4.8 + **F1** + **F2+F2.1 PositionState** + **F3 ExitPlan** + **F4 ExecutionPlan PAPER** + **ExitPermission** + Board echo 4.9 + Journal Attribution 6 + Thesis Health 5.0 + Protect/T1 5.1 + Exit Radar 5.2 + MFE/MAE 5.3 + Expectancy 8.0 + Trail 8.1 + Bracket 8.2 + I1 opening helper / HTTP gated trade, AUTO veto, Golden, **DS-05**, **DS-03** (**217**) |
