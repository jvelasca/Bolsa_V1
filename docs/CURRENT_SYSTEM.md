...
> **AsOf:** 2026-08-25 · **ADR-031** tesis ≠ plan ≠ permiso. HEAD **`a7eeaee`** Ciclo 4.2 `EntrySetup` (local, pendiente push). Relevo vivo: [`traspaso-relevo-ciclo-42-entrysetup-2026-08-25.md`](./engineering/traspaso-relevo-ciclo-42-entrysetup-2026-08-25.md). Alembic `010` en `bolsa_v1`.
