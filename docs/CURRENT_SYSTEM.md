...
> **AsOf:** 2026-08-25 · **ADR-031** tesis ≠ plan ≠ permiso. Ciclo 5.2 Exit Radar thin listo (pendiente commit). Relevo vivo: [`traspaso-relevo-ciclo-5-2-exit-radar-thin-2026-08-25.md`](./engineering/traspaso-relevo-ciclo-5-2-exit-radar-thin-2026-08-25.md). Previo origin: **`e937f72`**. Alembic `010` en `bolsa_v1`.
