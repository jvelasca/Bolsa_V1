...
> **AsOf:** 2026-08-25 · **ADR-031** tesis ≠ plan ≠ permiso. HEAD **`97f4862`** = `origin/main` (Ciclo 4.1 `NO_NEW_LONGS`). Relevo vivo: [`traspaso-relevo-ciclo-41-no-new-longs-2026-08-25.md`](./engineering/traspaso-relevo-ciclo-41-no-new-longs-2026-08-25.md). Alembic `010` en `bolsa_v1`.
