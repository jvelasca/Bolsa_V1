...
Dato → Assessment → run_decision_runtime → DecisionPackage
  → Policy Gate + check_opening (Fit de cesta + DS-05 freshness)
...
- DS-03 Mandate de cuenta: OperatingMandate = playbook ticker, no este gate (diferido).
