...
> **AsOf:** 2026-08-25 · **ADR-031** tesis ≠ plan ≠ permiso. HEAD local **`24b900a`** (stamp 8.1; feat `655832c`; 8.0 `cf880eb`; RX1 `9289b53`; origin aún `05e354c`). Relevo vivo: [`traspaso-relevo-ciclo-8-1-trail-thin-2026-08-25.md`](./engineering/traspaso-relevo-ciclo-8-1-trail-thin-2026-08-25.md) (Trail thin advisory; **hint only** · park 8.2 / trail plena). Alembic `010` en `bolsa_v1`.
