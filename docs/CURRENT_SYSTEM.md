...
> **AsOf:** 2026-08-25 · **ADR-031** tesis ≠ plan ≠ permiso. HEAD **`0af42c5`** = `origin/main` (Ciclo 5.3 `fd44a03`). Relevo vivo: [`traspaso-relevo-ciclo-5-3-mfe-mae-thin-2026-08-25.md`](./engineering/traspaso-relevo-ciclo-5-3-mfe-mae-thin-2026-08-25.md). Alembic `010` en `bolsa_v1`.
