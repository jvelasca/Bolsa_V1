...
> **AsOf:** 2026-08-25 · **ADR-031** tesis ≠ plan ≠ permiso. HEAD **`1cbd021`** (Ciclo 4.0 stop/entry_ready/size; local, pendiente push). Previo `17a386d` = TradePlan propose/confirm. Relevo: [`traspaso-relevo-ciclo-40-stop-entry-size-2026-08-25.md`](./engineering/traspaso-relevo-ciclo-40-stop-entry-size-2026-08-25.md). Alembic `010` en `bolsa_v1`.
