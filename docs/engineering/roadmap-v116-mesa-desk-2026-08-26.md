...
> **Tag objetivo:** **`v1.16-beta` → `f16119b`** (publicado).
...
| **MD-7** | Tag `v1.16-beta`          | **PUBLICADO** → `f16119b`                              | [`traspaso-relevo-tag-v1-16-beta-2026-08-26.md`](./traspaso-relevo-tag-v1-16-beta-2026-08-26.md)                   |
