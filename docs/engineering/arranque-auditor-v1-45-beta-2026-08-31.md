...
Eres auditor externo de Bolsa V1 **V1.45 PAPER AUTO position execute** (código sobre tip certificado **`v1.44-beta` → `db346a11`**). Aún **no** hay tag `v1.45-beta` salvo que el owner lo haya creado; audita el HEAD de este slice.
