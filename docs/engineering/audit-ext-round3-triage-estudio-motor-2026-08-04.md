...
| 5 | **AUTO** (prep) | **A0 telemetría** + OR-lite + **OR-RE Risk Engine** ([triage institucional §9](./audit-ext-institutional-pre-auto-triage-2026-08-04.md)) | Flip `PAPER_D_EXECUTE` sin evidencia; Lab→Broker sin Risk |
