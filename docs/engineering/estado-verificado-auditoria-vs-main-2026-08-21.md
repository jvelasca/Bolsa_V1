...
5. **Crash / kill entre cash y ledger** (atomicidad real) → ⏳ **PLAN (Fase 4, chaos)** — no existe ningún test/script de chaos en HEAD. Candidato a siguiente fase.
