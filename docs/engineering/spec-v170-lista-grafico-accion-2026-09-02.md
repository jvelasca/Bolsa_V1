...
> **AsOf:** 2026-09-02 · **Estado:** **CERRADA con reservas de certificación** (pre-flight local 2026-09-02 · commit `960383d2`). Playwright integrado **opt-in** — **no** stamp CI GREEN.  
