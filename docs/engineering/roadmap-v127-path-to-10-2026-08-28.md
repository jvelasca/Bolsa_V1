...
| **V1.42 Operating Excellence**                                        | **SPEC** [`spec-v142-operating-excellence-2026-08-31.md`](./spec-v142-operating-excellence-2026-08-31.md) · [ADR-042](../adr/042-operating-excellence.md) — código parked (F1–F7); **F8a** dry-run ops adelantado V1.33.4 | OpportunityScore, flip execute, drag  |
