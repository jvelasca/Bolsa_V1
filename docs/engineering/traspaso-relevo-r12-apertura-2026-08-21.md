...
> **AsOf:** leftover CORE-R **hecho** `8dd3caf`. Copy E8 residual **`ce601c9`** (firma → Confirmar · atajos Señales/Laboratorio). SHA vivo = `git fetch` + `origin/main`.
...
> Track C **C1–C5** (`0eb8976`) + leftover CORE-R **hecho `8dd3caf`** + copy E8 residual **`ce601c9`**. Fuente viva = `origin/main`. Gates 409/EXEC-B/scheduler no auto. Tag `v1.5.0-beta` solo si el propietario lo pide.
