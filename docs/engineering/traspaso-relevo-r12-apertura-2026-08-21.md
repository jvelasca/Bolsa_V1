...
> **AsOf:** HEAD local = **`9f3354f`** · `origin/main` = **`8ab6ef3`** hasta push · tag **`v1.5.0-beta` → `5e52bd6`** (R12-SCHED; **el tag no se mueve**). Track C C1–C5 · copy E8 · leftover CORE-R · gates R12-409 / EXEC-B-CONC / R12-SCHED / **R12-ACCOUNTS** / **R12-AUTH F1+F2** **cerrados**. Pending-delete E8 tests **sin purge**.
...
- Gates: **R12-409** `eb24608` · **EXEC-B-CONC** `ca60d0a` · **R12-SCHED** `5e52bd6` · **R12-ACCOUNTS** `3c958f1` · **R12-AUTH F1** `e52e016` · **F2** `9f3354f`. Pending-delete E8 tests **`851b545`** (**sin purge**).
...
| R12-AUTH F2       | `9f3354f` | CORE-R/mandatos/F3/perfil + GET cartera/`X-Account-Id`; trade/cash fuera |
