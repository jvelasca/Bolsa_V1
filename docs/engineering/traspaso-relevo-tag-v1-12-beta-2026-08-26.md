...
> **Estado:** **PUBLICACIÓN.** Tag `v1.12-beta` (SHA = stamp commit; pin docs post Release tag CI GREEN).  
...
| Pieza        | Valor                                                                                          |
| ------------ | ---------------------------------------------------------------------------------------------- |
| Tag          | `v1.12-beta` (SHA al stamp; pin post-CI)                                                       |
...
```bash
git tag v1.12-beta          # SHA del stamp
