...
| `v2.43.1-beta` @ `b27280de` | Release tag CI | **GREEN** — 10 jobs requeridos + `certify (aggregate + artifact)` en `success`; job `python` offline **2002 passed, 35 skipped**, `lifecycle-pg` con **PG real** **144 + 45 passed**; `playwright (integrated E2E)` `skipped` por opt-in | [`35344945138`](https://github.com/jvelasca/Bolsa_V1/actions/runs/35344945138) |
