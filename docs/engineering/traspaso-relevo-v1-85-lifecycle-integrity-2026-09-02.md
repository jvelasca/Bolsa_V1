...
- Tag `v1.85-beta` / CI remoto = paso posterior
...
```text
Partida: V1.85 CERRADA (pre-flight) · partida tip V1.84 504aa19d PASS 9,5/10.
Leer: docs/CURRENT_SYSTEM.md · docs/engineering/traspaso-relevo-v1-85-lifecycle-integrity-2026-09-02.md · spec-v185.
