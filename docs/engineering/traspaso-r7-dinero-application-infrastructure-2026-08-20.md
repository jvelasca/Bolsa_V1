...
>
> **SIGUIENTE ETAPA (por decisión 2026-08-20): FIN de R-7** — deuda de dinero real de R-7 **completa** (Alto×3 + Medio×7 + Baja **B-1** + Baja **B-3** + Baja **B-4** cerradas). Quedan **Bajas**: **B-5** (FIFO quantity==0 / PnL whole-account) · B-2 (unrealized silencia sin precio) · **M-4/T-M4** (job dedicado, DIFERIDO por freeze). **Se decide NO pausar ahora:** cuando R-7 quede del todo cerrado → **guardar + auditorías externas**. **L-M3/M-5 CERRADA · M-1 · M-2 · M-3 · M-6 · M-4/T-M5 · M-7 · B-1 · B-3 · B-4 TODAS CERRADAS.**
>
...
**Estado al cerrar (verificado):** `main` limpio, sincronizado con `origin/main` · **CERRADAS: L-M3/M-5 (F3) · M-1 · M-2 · M-3 · M-6 · M-4/T-M5 · M-7 · B-1 · B-3 · B-4** → **Alto×3 + Medio×7 + Baja B-1 + Baja B-3 + Baja B-4 de R-7 COMPLETADAS** · **T-M4 (job dedicado) DIFERIDO** por freeze · ancla `docs/engineering/backlog-trabajo-2026-08-20.md` §0 al día (LEER PRIMERO al abrir).
...
**Estado al abrir:** `local main = origin/main` (cierre B-4 `3712e63` + docs actualizados), árbol limpio. **CERRADAS: L-M3/M-5 (F3) · M-1 · M-2 · M-3 · M-6 · M-4/T-M5 · M-7 · B-1 · B-3 · B-4.** Quedan **Bajas de R-7: B-5 · B-2** (+ **M-4/T-M4 DIFERIDO** por freeze).
...
3. **B-5 (T-M9/T-M10)** — FIFO divide sin guard `quantity==0`; `fetch_core_r_pnl_extra_rows` atribuye PnL whole-account a un instrumento (fail-open). Riesgo verdad. **[SIGUIENTE del FIN de R-7]**
