...
> **Estado:** **TIP LOCAL** — tip `v1.48-beta` pendiente (HEAD post close-out) · push + Release-tag CI · auditoría externa.  
...
| Pieza       | Valor                                               |
| ----------- | --------------------------------------------------- |
| Tag tip     | `v1.48-beta` → _(pendiente SHA post close-out)_     |
| Código base | `b1805c7d` feat(v1.48) Event Continuity + close-out |
