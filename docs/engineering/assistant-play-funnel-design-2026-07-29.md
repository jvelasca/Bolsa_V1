...
**Hecho (v0.1 · 2026-08-01):** meseta heatmap → espacio guiado más ancho; pico → más estrecho; snapshot `plateau` en memoria/stamp/hint.

**Hecho (v0.2 · 2026-08-01):** familia Lab por defecto = adopción → horizonte perfil (`resolveDefaultLabFamily`); semilla Coach sigue mandando.

**Siguiente ciclo:** sin reabrir P3–P9.
...
H. CORE B Lab IA — **v0.2 hecho** (memoria + meseta→espacio + familia por horizonte); P3–P9 = decisión
