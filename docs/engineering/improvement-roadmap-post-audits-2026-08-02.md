...
6. **Ya existe producto operativo** (Play, Finalistas, DÍA D, Mandato): el roadmap _no_ lo deshace; lo endurece.
...
**Objetivo:** poder responder _¿está sano el laboratorio?_ sin abrir C4 ni Belief.
...
| Q0.4 | Doc limitación ranking      | Cross-family: Sharpe mediano ≠ verdad; tradeCount/Calmar como _caveat_ en C3.5 / HELP                         | XS       |
...
**Objetivo:** dejar de extrapolar desde _un_ experimento temporal.
...
| Q1.2 | **Campañas de estabilidad**              | Repetir protocolo C3-like en ≥2 ventanas (p. ej. 2022–23 vs 2024–25) _sin_ nueva familia               | M        |
...
_Siguiente paso operativo sugerido: empezar Q0.1 (Lab Health) en un PR pequeño._
...
| Q3.2 Multi-ventana embudo           | Hecho (v1) — `coachFacts.labEvidence` + badge Finalistas/Coach (Hold-out/WF/CPCV); Δ campañas = Observatory |
