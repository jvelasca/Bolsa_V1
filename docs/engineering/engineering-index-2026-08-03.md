...
16. **Auditoría consolidada interna+externas + plan hardening (2026-08-11):** [audit-consolidado-internas-externas-2026-08-11.md](./audit-consolidado-internas-externas-2026-08-11.md) — 4 fuentes cruzadas (interna · externa 1 · externa 2 · externa 3) · mapa P0/P1/P2 · plan F1–F5 · decisiones D0–D5 pactadas · checkpoint git `audit-checkpoint-2026-08-11` · NO tocar código
    ...
    >         └── **F1 — traspaso de hilo:** [traspaso-f1-integridad-financiera-2026-08-11.md](./traspaso-f1-integridad-financiera-2026-08-11.md) — documento de trabajo F1 (integridad financiera) EN CURSO · rama `stage/f1-integridad-financiera-2026-08-11` creada desde `7edb3d1` · **M1 commit `3d093cb`** (with_for_update) · **M2 commit `113e27a`** (deduct_cash allow_partial, Opción B) · M3 sig. · M2 resuelta (Opción B `allow_partial`) · orden M1→M5
