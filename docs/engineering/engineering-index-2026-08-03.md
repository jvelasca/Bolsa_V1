...
│   ├── traspaso-higiene-formato-legacy-salida-2026-08-11.md ← M0/§6.2 higiene Prettier legacy: SALIDA/RELEVO (punto de entrada del siguiente hilo) · protocolo 8 pasos + EOL check · avance 1-19 (227 files) HEAD `689c294` · `coach`/`lab` HECHO lote 14 · `hub` HECHO lote 15 · `chart` HECHO lote 16 · `misc`/motores HECHO lote 17 · cierre misc HECHO lote 18 · **`features/backtests` COMPLETO** · **`accounts` HECHO lote 19 (primer sub-lote resto `apps/web/src`)** · siguiente: otro dominio del resto `apps/web/src` · ver §7.6.i
