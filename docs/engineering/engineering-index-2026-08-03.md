...
│   ├── traspaso-higiene-formato-legacy-salida-2026-08-11.md ← M0/§6.2 higiene Prettier legacy: SALIDA/RELEVO (punto de entrada del siguiente hilo) · protocolo 8 pasos + EOL check · avance 1-23 (283 files) HEAD `4300674` · `features/backtests` COMPLETO (lotes 2-18) · **`accounts` 19 · `workspace` 20 · `config`+`platform` 21 · `research` 22 · `settings` 23 HECHOS (resto `apps/web/src`)** · siguiente: otro dominio del resto `apps/web/src` · ver §7.6.i
