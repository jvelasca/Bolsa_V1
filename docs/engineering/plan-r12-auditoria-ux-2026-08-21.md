...
| Auth User→Account→Resource       | F1 single-tenant `user_id` / 404; JWT sigue D4                      | ✅ **F1 HECHO** (`e52e016`)                |
