...
> **Estado del plan (AsOf 2026-08-22):** … **R12-AUTH F1–F10 + F8b–F8e** · **F7b script** · **JWT-only**. **`origin/main` `e106133`**. Siguiente: monitor ventana purge V2 (E8 N) · apply F7b en ventana · F7c opcional.
