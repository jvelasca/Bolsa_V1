...
| Pieza                           | Path                    | Límite                                                     |
| ------------------------------- | ----------------------- | ---------------------------------------------------------- |
| Consola `/operational-console`  | ADR-040 · GP-E2E-02     | Diagnóstico; **no** L1                                     |
...
| Auth JWT + roles                | CURRENT_SYSTEM Auth     | `require_role` disponible; la mayoría de rutas solo sesión |
...
| --------- | ----------------------------------------- | --------------------------------------------------------- |
| **OR-01** | No hay load test formal HTTP/UI           | Diferir · medir solo sesión A/B                           |
