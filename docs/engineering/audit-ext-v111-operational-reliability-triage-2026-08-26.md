...
> **AsOf:** 2026-08-26. **Estado:** **RATIFICADO.** Operational Integrity v1.11 **CERRADA**. **OR-1/3/4/5/6 CERRADOS** · **OR-2 PARTIAL** post-audit v1.12 (spine 433 · tag `v1.12-beta`). Siguiente = V1.13 Durable Execution. Auditoría 2 **aparcada** (owner).
> **Hijos:** [`roadmap-v112-operational-reliability-2026-08-26.md`](./roadmap-v112-operational-reliability-2026-08-26.md) · ADR-035 · planes OR-1…OR-6 · triage post-v1.12 [`audit-ext-v112-durable-execution-triage-2026-08-26.md`](./audit-ext-v112-durable-execution-triage-2026-08-26.md).
...
| 2   | Crash/restart recovery (submit → crash → reconstruye UNKNOWN)                           | **PARTIAL (OR-2)**        | `DurableSubmitIntent` pre-submit + recovery sin re-POST. Store InMemory de proceso (**no sobrevive al PID**). Tabla PG / Redis multi-worker → **DEX-1** (auditoría post-`v1.12-beta`).                                                                                                                               |
