...
> **Tip producto vigente:** [`v2.4-beta`](./traspaso-relevo-tag-v2-4-beta-2026-09-04.md) `8fda4d62`.  
> **Para quién:** agente nuevo · V2.5 cerrado en working tree · tip `v2.5-beta` **no stampado** · **NO MÁS PANELES** · no reabrir motor FSM · no rehacer IDs V2.33–V2.35 salvo regresión.

## Estado al relevo

| Corte                             | Estado                             |
| --------------------------------- | ---------------------------------- |
| V2.33 Protection honesty          | **hecho** (código, sin commit/tip) |
| V2.34 Premium UX                  | **hecho**                          |
| V2.35 UI Truth + responsive/touch | **hecho**                          |
| Tip `v2.5-beta`                   | **pendiente** (solo con pedido)    |
| Commit working tree V2.5          | **pendiente** (solo con pedido)    |
| Reinicio API Python (wire POV)    | **pendiente ops**                  |
...
Si ops: reiniciar API Python (wire `PROTECT_REQUIRED` birth) · smoke browser 10 s.  
Si tip/commit: solo con pedido explícito · no bump `1.35.0-beta`.  
...
> Lee `docs/engineering/arranque-agente-post-v2-35-2026-09-05.md` y el relevo V2.5 (cerrado en código). No tip/commit sin pedirlo. Freeze intacto. NO MÁS PANELES. Reiniciar API si el wire sigue stampando PROTECT_REQUIRED en fills sanos.
...
| ------------------ | ------------------------------------------------------------------- |
| Branch             | `main`                                                              |
| Tip GitHub vigente | [`v2.4-beta`](https://github.com/jvelasca/Bolsa_V1/commit/8fda4d62) |
| Código V2.5        | working tree (sin tip)                                              |
