...
| Rama de auditoría | `auto-15-data-gate-persistido` · **PR draft [#65](https://github.com/jvelasca/Bolsa_V1/pull/65)** (abierto **post-sello**, no es vehículo de merge) | delta completo sobre `v2.55`: `audit-base-v2.55-beta` @ `b96ae624` → `8ad54416` (**22 ficheros, `+2994/−24`**) |
