...
| Working tree   | limpio                                                                                                                                                                                                                                                                                                                                    |
| Fase R-7       | Auditoría COMPLETADA · **F1 PUSHEADA** (`c957df1`) · **F2 PUSHEADA** (`8c081ea`) · **F3 (L-M3/M-5) PUSHEADA** (`d7b8db8`) · **M-1 (T-M1) PUSHEADA** (`a78eb29`) · **M-2 (T-M2) PUSHEADA** (`c8e9ced`) · **M-3 (T-M3) PUSHEADA** (`6962fd7`) · **M-6 (T-M6) PUSHEADA** (`604bfef`) · **M-4 (T-M5, opción B acotada) PUSHEADA** (`6a1759c`) |
...
>
> **RELEVO → SIGUIENTE por decisión: M-7 (L-M5) custodia dedup time-only** (mutex como única capa tras L-M3/M-5; restart/R-expiry puede re-cobrar). **M-4 T-M5 (mezcla fees) CERRADA** (`6a1759c`, opción B acotada); la parte T-M4 de M-4 (custodia side-effect en GET) queda **diferida** por colindar con «sin features» (job dedicado). Ver texto de traspaso completo en `docs/engineering/traspaso-r7-dinero-application-infrastructure-2026-08-20.md` **§8**.
