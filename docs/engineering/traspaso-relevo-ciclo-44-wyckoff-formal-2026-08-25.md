...
> **AsOf:** 2026-08-25.
> **HEAD:** (stamp tras push). Feat `7003ddf`.
...
| 4.4   | `7003ddf`          | Wyckoff formal: spring + reclaim estricto (`k×ATR=0.25` **o** fuera rango spring); SOS etiqueta; LPS diferido |
