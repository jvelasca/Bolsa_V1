...
> **Estado:** **EN CURSO.** B0 plan ✅ · **B1–B5 código ✅** (`6271c8c`·`fcdc857`·`bcadea9`·`5475c09`·`ca13981`) · B6–B12 pendientes. Relevo vivo: `traspaso-relevo-track-b-b5-apertura-b6-2026-08-23.md`.
> **AsOf:** 2026-08-23 · HEAD vivo = `git rev-parse origin/main` (partida B5 = `ca13981`).
