...
> **AsOf:** 2026-08-25.
> **HEAD:** pendiente commit/push (feat local). Previo SoT `e937f72` = `origin/main`.
...
| SHA           | Mensaje                                         |
| ------------- | ----------------------------------------------- |
| _(pendiente)_ | feat(spine): ADR-031 Ciclo 5.2 Exit Radar thin. |
| _(pendiente)_ | docs: stamp living SoT after Ciclo 5.2.         |
