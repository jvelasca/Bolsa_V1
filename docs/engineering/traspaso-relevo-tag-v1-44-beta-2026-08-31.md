...
> **Estado:** **TIP PUBLICADO** — tag `v1.44-beta` → `db346a11` (was `57cf41a3`; CI unblock ruff I001) · Release-tag CI **pending** tras retag. Auditoría de contrato local **PASS**.  
...
| Código contrato | `57cf41a3` feat + `db346a11` `fix(ci): sort position_revision test imports for ruff` |
...
Resultado local (2026-08-31): shared build OK · 47 shared + 20 web · tsc OK · pytest **40 passed** · ruff OK tras sort imports. Auditoría externa contrato: **PASS** (9/9).
