...
| R-8C               | `3ad48aa`                                         | Invariante DB `balance_after` por grupo atómico + deuda R-8C.2 (scheduler-vs-worker) documentada                                                                                      |
