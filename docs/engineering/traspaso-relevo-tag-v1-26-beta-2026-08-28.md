...
> **Estado:** **PUBLICACIÓN** — tag `v1.26-beta` → `96c0d5d7`.  
> **Siguiente código:** V1.27 Position Operating Model — [`roadmap-v127-path-to-10-2026-08-28.md`](./roadmap-v127-path-to-10-2026-08-28.md) · [`traspaso-relevo-v1-27-position-operating-model-2026-08-28.md`](./traspaso-relevo-v1-27-position-operating-model-2026-08-28.md).  
...
- Deuda abierta: V1.28 cockpit/toasts · Frente A/B hasta N4 + §8 ACUERDO — **no mezclar**. Lab `risk_policy` cableado en V1.27.

## 1. Release

| Pieza   | Valor                                                                                                                                                     |
| ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Tag     | `v1.26-beta` → `96c0d5d7`                                                                                                                                 |
