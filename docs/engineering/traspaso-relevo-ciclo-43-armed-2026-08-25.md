...
> **AsOf:** 2026-08-25.
> **HEAD:** `4fc864b` = `origin/main`. Feat `4eb99a2` **PUSHEADO**.
...
| 4.3   | `4eb99a2` (origin) | `ARMED` = stop + setup≠none + !ready · qty 0 · `whyNot: entry` · actionability 0.7            |
...
| `4fc864b` | docs: finalize Ciclo 4.3 handoff relevo SHAs.          |

Push: `07d1fab..4fc864b` → `origin/main`.
