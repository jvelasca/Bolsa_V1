...
| **Git tag** | Tip certificado para auditoría / CI-by-tag                            | `git tag` · GitHub Releases               | `v1.44-beta` → `57cf41a3` |
...
1. **El tip certificado es el git tag**, no el `version` de npm. Un auditor cita `v1.44-beta` → `57cf41a3`.
