...
| **Git tag** | Tip certificado para auditoría / CI-by-tag                            | `git tag` · GitHub Releases               | `v1.45-beta` → `1627e9c9` |
...
1. **El tip certificado es el git tag**, no el `version` de npm. Un auditor cita `v1.45-beta` → `1627e9c9`.
