...
| **Git tag** | Tip certificado para auditoría / CI-by-tag                            | `git tag` · GitHub Releases               | `v1.42-beta` → `5e3fb1a4` |
...
1. **El tip certificado es el git tag**, no el `version` de npm. Un auditor cita `v1.42-beta` → `5e3fb1a4`.
