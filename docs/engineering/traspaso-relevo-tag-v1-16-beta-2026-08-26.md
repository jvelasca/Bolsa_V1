...
> **Estado:** **PUBLICACIÓN** — tag `v1.16-beta` → `f16119b`. **Release tag CI:** pendiente pin GREEN.
...
- **MD-0 + MD-1…MD-5:** código + tests + relevos epic; feature **`11ee5ff`** + CI fixes → tag **`f16119b`**.
