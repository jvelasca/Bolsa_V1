...
| **`Release tag CI`** del tag `v2.45-beta`                                                                              | `python` offline, `lifecycle-pg` con el **paso dedicado** del día real y el guard anti-skip, `certify` en `success`: job `python` **2098 passed, 35 skipped** (los **+12** sobre 2086) y el paso dedicado `Pytest Golden Day 2.0 (proceso scheduler V2 + PG, fail if skipped)` **1 passed en 9,32 s** con `AUTO_GOLDEN_DAY_V2_PG_REQUIRED=1` (run [`35522747332`](https://github.com/jvelasca/Bolsa_V1/actions/runs/35522747332)); en la ref del tag, `Python CI` run [`35522747381`](https://github.com/jvelasca/Bolsa_V1/actions/runs/35522747381) **GREEN 5/5** con `quality` **2087 passed, 38 skipped** |
