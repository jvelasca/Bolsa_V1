...
> **Estado:** **ABIERTA** · Partida V1.86 PASS arquitectura [`baaa7034`](https://github.com/jvelasca/Bolsa_V1/commit/baaa7034) · auditoría [`respuesta-auditor-v186-lifecycle-event-store-2026-09-02.md`](./respuesta-auditor-v186-lifecycle-event-store-2026-09-02.md).
...
| —   | Tag `v1.87-beta` / CI remoto GREEN                                        | posterior |
