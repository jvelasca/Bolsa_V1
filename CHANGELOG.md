...
- **ADR-031 / TradePlan en propose+confirm** (working tree, pendiente commit): `data.tradePlan` + `runtime.tradePlan`; confirm echo; Hoy prefiere plan vivo. Spine **67**. Sin `contract:gen`.
